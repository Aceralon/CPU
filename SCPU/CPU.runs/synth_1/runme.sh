...
HD_PWD='C:/Users/aceralon/Documents/GitHub/CPU/CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys.tcl
