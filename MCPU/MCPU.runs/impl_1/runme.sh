...
HD_PWD='C:/Users/aceralon/Documents/GitHub/CPU/CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys.tcl -notrace
